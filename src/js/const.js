export const verifyRule = {
  // 常用验证
  mobile: {
    reg: /^1[3|4|5|6|7|8|9][0-9]{9}$/, // ^(861((33|49|53|7[37]|8[019]|99)|(3[012]|45|5[56]|66|7[56]|8[56])|(3[456789]|47|5[012789]78|8[23478]))[0-9]{8}$)|^(?!86)\d+
  ...
  userPsw: {
    ...
    error: '密码需为字母和数字组成的6-18位字符'
  },
  psw: {
    // reg: /^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,24}$/,
    // error: '密码有误,6到24位字母和数字组合',
    // tip: '密码须为字母和数字组成的6-24字符'
    reg: /^[a-zA-Z0-9]{6,24}$/,
    error: '密码有误,6到24位字母或数字',
    tip: '密码须为6到24位字母或数字'
  },
  repeatPsw: {
    // reg: /^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,24}$/,
...
export const listhelp = [
  ...
  {
    title: '我在哪里可以找到彩票游戏？',
    message: '请您登陆您在彩天堂娱乐注册的会员账号后，点击网站首页上方「彩票中心」选择相应的彩票类型进入即可。'
  },
  {
    title: '我想买彩票，有什么要求吗？',
    message: '购买彩票并无特定要求，未满18岁的人士进行博彩属非法行为，在此方面绝对严格执行，用户需为年满18岁的公民并有完全行为能力，您只需拥有彩天堂娱乐的会员账号且充值成功后，即可进入彩票页面进行投注。'
  },
  {
  ...
  },
  {
    ...
    message: '彩天堂娱乐彩票根据官方开奖结果进行派彩，中奖后系统自动将奖金添加至您的彩天堂娱乐会员账号中，您点击网站首页的「取款」即可提取您的奖金。'
  },
  {
    title: '我想查询已开奖的中奖号码，该怎么办？',
    message: '请您登陆您的彩天堂娱乐会员账号后，在【彩票中心】中选择任一彩种，「订单记录─游戏记录」即可查看您的中奖号码；或至在用户名下拉式表单点选【订单报表】中选择任一彩种，「订单记录─游戏记录」即可查看您的中奖号码。'
  },
  {
    title: '什么是追号、该如何追号？',
  ...
  {
    title: '什么是奖金限额？',
    message: '彩天堂娱乐对时时彩单期最高奖金限红为40W元，其余高频彩种单期最高奖金限红为20W元，低频彩种单期最高奖金限红为10W元，如奖金超出相应彩种的最高限红，超出的部分将不做赔付。'
  },
  {
...
export const path = window.location.origin;
